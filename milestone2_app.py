...
Milestone 2: Global Financial Institutions CTI Platform — Data Collection & Integration
Team: Devansh Agarwal (Lead), Anica, Noreen, Guled, Ville

M2 Additions:
  - Data Sources page: URLhaus, MalwareBazaar, Ransomware.live, ThreatFox, SEC EDGAR 8-K
  - Dynamic Data Explorer (required interactive explorer)
  - Ethics & Data Governance section
  - Security-Aware Development Practices section
...
with st.sidebar:
    ...
    st.divider()
    _caption("Data: CISA KEV · EPSS · URLhaus · MalwareBazaar · Ransomware.live · ThreatFox · SEC EDGAR")
...
if page == "✅  What's New":
    ...
    tab_m1, tab_m2 = st.tabs(["📋 Milestone 1 (March 26)", "📋 Milestone 2 (April 9)"])
...
# ─────────────────────────────────────────────
    ...
    st.info("Use the navigation links above and below this separator to explore Milestone 1 or Milestone 2 sections.")
...
# ─────────────────────────────────────────────
    ...
    **References (APA Format)**
    ...
    6b. abuse.ch. (2025). *MalwareBazaar: Malware Sample Sharing Platform*. https://bazaar.abuse.ch/
